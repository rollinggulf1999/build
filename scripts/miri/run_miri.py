...
def main():
    ...
    try:
        ...
        # f"--crate-name={target_name}", "--crate-type=lib"
        ...
        # 单独运行ls miri-sysroot
        # command_and_args_2 = ["ls", sys.argv[5]]
        # process_2 = subprocess.Popen(command_and_args_2,
        #                              env=os.environ,
        #                              stdout=subprocess.PIPE,
        #                              stderr=subprocess.PIPE,
        #                              text=True)
        ...
        #     print(stdout_2, end="")
        # if stderr_2:
        #     print(stderr_2, end="", file=sys.stderr)
